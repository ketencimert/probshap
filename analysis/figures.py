...
if __name__ == '__main__':
    ...
    parser.add_argument('--row_size', default=5, type=int)

    parser.add_argument('--model_name', default='VariationalShapley', type=str)
    parser.add_argument('--prior', default='masked', type=str)
    parser.add_argument('--estimate', default='FEEDFORWARD', type=str)
    parser.add_argument('--beta', default=1, type=float)
    parser.add_argument('--inc_beta', default=False)
    parser.add_argument('--act', default='snake', type=str)

    parser.add_argument('--deviation', default=1, type=int)
    ...
    figsize = [4 * column_size , 4 * args.row_size]
    ...
    fig.tight_layout()
    plt.savefig(
        './figures/{}_all.pdf'.format(args.dataset),
        format='pdf',
        transparent=True,
        bbox_inches='tight'
        )
