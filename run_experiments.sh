...
FLAGS_LIST=(
# "--d_hid 500 --d_emb 20 --n_layers 4 --dataset mnist_normal_0 --device cuda:0 --phi_net masked --act elu --model_id 0 --norm None --early_stop 40 --cv_folds 1 --cont"
# "--d_hid 500 --d_emb 20 --n_layers 4 --dataset mnist_normal_1 --device cuda:1 --phi_net masked --act elu --model_id 0 --norm None --early_stop 40 --cv_folds 1 --cont"
# "--d_hid 500 --d_emb 20 --n_layers 4 --dataset mnist_normal_2 --device cuda:2 --phi_net masked --act elu --model_id 0 --norm None --early_stop 40 --cv_folds 1 --cont"
# "--d_hid 500 --d_emb 20 --n_layers 4 --dataset mnist_normal_3 --device cuda:0 --phi_net masked --act elu --model_id 0 --norm None --early_stop 40 --cv_folds 1 --cont"
