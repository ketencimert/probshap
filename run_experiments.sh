...
FLAGS_LIST=(
"--d_hid 400 --d_emb 20 --n_layers 4 --dataset mnist_normal_0 --device cuda:0 --phi_net masked --act elu --model_id 1 --norm None --early_stop 300 --cv_folds 1"
"--d_hid 400 --d_emb 20 --n_layers 4 --dataset mnist_normal_0 --device cuda:1 --phi_net masked --act elu --model_id 2 --norm None --early_stop 300 --cv_folds 1"
"--d_hid 400 --d_emb 20 --n_layers 4 --dataset mnist_normal_0 --device cuda:2 --phi_net masked --act elu --model_id 3 --norm None --early_stop 300 --cv_folds 1"
"--d_hid 400 --d_emb 20 --n_layers 4 --dataset mnist_normal_0 --device cuda:3 --phi_net masked --act elu --model_id 4 --norm None --early_stop 300 --cv_folds 1"
"--d_hid 400 --d_emb 20 --n_layers 4 --dataset mnist_normal_0 --device cuda:0 --phi_net masked --act elu --model_id 5 --norm None --early_stop 300 --cv_folds 1"
"--d_hid 400 --d_emb 20 --n_layers 4 --dataset mnist_normal_0 --device cuda:1 --phi_net masked --act elu --model_id 6 --norm None --early_stop 300 --cv_folds 1"
"--d_hid 400 --d_emb 20 --n_layers 4 --dataset mnist_normal_0 --device cuda:2 --phi_net masked --act elu --model_id 0 --norm None --early_stop 300 --cv_folds 1"
